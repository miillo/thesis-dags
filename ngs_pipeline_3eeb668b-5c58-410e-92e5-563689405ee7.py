...
dag_run_uuid = "3eeb668b-5c58-410e-92e5-563689405ee7"
...
with DAG(
    dag_id="ngs-pipeline-3eeb668b-5c58-410e-92e5-563689405ee7",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="1024m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-3eeb668b-5c58-410e-92e5-563689405ee7.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-3eeb668b-5c58-410e-92e5-563689405ee7.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
