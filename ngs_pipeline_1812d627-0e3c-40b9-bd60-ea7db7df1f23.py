...
dag_run_uuid = "1812d627-0e3c-40b9-bd60-ea7db7df1f23"
...
with DAG(
    dag_id="ngs-pipeline-1812d627-0e3c-40b9-bd60-ea7db7df1f23",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-1812d627-0e3c-40b9-bd60-ea7db7df1f23.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-1812d627-0e3c-40b9-bd60-ea7db7df1f23.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
