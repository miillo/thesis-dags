...
dag_run_uuid = "15feb418-b8c4-4e46-b642-df323a24773b"
...
with DAG(
    dag_id="ngs-pipeline-15feb418-b8c4-4e46-b642-df323a24773b",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-15feb418-b8c4-4e46-b642-df323a24773b.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-15feb418-b8c4-4e46-b642-df323a24773b.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
