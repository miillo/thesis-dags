...
dag_run_uuid = "ced2ffb7-f6b8-41d0-b547-f7e037a18182"
...
with DAG(
    dag_id="ngs-pipeline-ced2ffb7-f6b8-41d0-b547-f7e037a18182",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-ced2ffb7-f6b8-41d0-b547-f7e037a18182.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-ced2ffb7-f6b8-41d0-b547-f7e037a18182.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
