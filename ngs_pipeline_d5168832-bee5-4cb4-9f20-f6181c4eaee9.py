...
dag_run_uuid = "d5168832-bee5-4cb4-9f20-f6181c4eaee9"
...
with DAG(
    dag_id="ngs-pipeline-d5168832-bee5-4cb4-9f20-f6181c4eaee9",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="600m",driver_memory="750m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-d5168832-bee5-4cb4-9f20-f6181c4eaee9.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-d5168832-bee5-4cb4-9f20-f6181c4eaee9.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
