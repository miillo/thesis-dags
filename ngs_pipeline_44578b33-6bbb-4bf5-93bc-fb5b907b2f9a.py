...
dag_run_uuid = "44578b33-6bbb-4bf5-93bc-fb5b907b2f9a"
...
with DAG(
    dag_id="ngs-pipeline-44578b33-6bbb-4bf5-93bc-fb5b907b2f9a",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="6",executor_memory="600m",driver_memory="750m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-44578b33-6bbb-4bf5-93bc-fb5b907b2f9a.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-44578b33-6bbb-4bf5-93bc-fb5b907b2f9a.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
