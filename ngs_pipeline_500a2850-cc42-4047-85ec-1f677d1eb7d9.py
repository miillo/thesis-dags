...
dag_run_uuid = "500a2850-cc42-4047-85ec-1f677d1eb7d9"
...
with DAG(
    dag_id="ngs-pipeline-500a2850-cc42-4047-85ec-1f677d1eb7d9",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="6",executor_memory="650m",driver_memory="512m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-500a2850-cc42-4047-85ec-1f677d1eb7d9.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-500a2850-cc42-4047-85ec-1f677d1eb7d9.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
