...
dag_run_uuid = "a7637f38-3f1d-4fb1-b928-7080a737e784"
...
with DAG(
    dag_id="ngs-pipeline-a7637f38-3f1d-4fb1-b928-7080a737e784",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="512m",driver_memory="512m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-a7637f38-3f1d-4fb1-b928-7080a737e784.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-a7637f38-3f1d-4fb1-b928-7080a737e784.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
