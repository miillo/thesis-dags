...
dag_run_uuid = "42400e2b-c6b3-4bb8-981a-a1e750fef34a"
...
with DAG(
    dag_id="ngs-pipeline-42400e2b-c6b3-4bb8-981a-a1e750fef34a",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-42400e2b-c6b3-4bb8-981a-a1e750fef34a.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-42400e2b-c6b3-4bb8-981a-a1e750fef34a.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
