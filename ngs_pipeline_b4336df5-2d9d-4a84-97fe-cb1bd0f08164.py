...
dag_run_uuid = "b4336df5-2d9d-4a84-97fe-cb1bd0f08164"
...
with DAG(
    dag_id="ngs-pipeline-b4336df5-2d9d-4a84-97fe-cb1bd0f08164",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="512m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-b4336df5-2d9d-4a84-97fe-cb1bd0f08164.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-b4336df5-2d9d-4a84-97fe-cb1bd0f08164.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
