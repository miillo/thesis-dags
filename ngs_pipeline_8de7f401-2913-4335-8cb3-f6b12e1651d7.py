...
dag_run_uuid = "8de7f401-2913-4335-8cb3-f6b12e1651d7"
...
with DAG(
    dag_id="ngs-pipeline-8de7f401-2913-4335-8cb3-f6b12e1651d7",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="300m",driver_memory="2048m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-8de7f401-2913-4335-8cb3-f6b12e1651d7.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-8de7f401-2913-4335-8cb3-f6b12e1651d7.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
