...
dag_run_uuid = "e84ecf32-c90f-4cd2-b87a-e6c9e9719d72"
...
with DAG(
    dag_id="ngs-pipeline-e84ecf32-c90f-4cd2-b87a-e6c9e9719d72",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="500m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-e84ecf32-c90f-4cd2-b87a-e6c9e9719d72.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-e84ecf32-c90f-4cd2-b87a-e6c9e9719d72.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
