...
dag_run_uuid = "d9743f8b-2b21-415c-9164-232808ed542e"
...
with DAG(
    dag_id="ngs-pipeline-d9743f8b-2b21-415c-9164-232808ed542e",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="10",executor_memory="1024m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-d9743f8b-2b21-415c-9164-232808ed542e.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-d9743f8b-2b21-415c-9164-232808ed542e.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
