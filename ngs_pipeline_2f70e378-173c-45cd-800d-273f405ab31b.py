...
dag_run_uuid = "2f70e378-173c-45cd-800d-273f405ab31b"
...
with DAG(
    dag_id="ngs-pipeline-2f70e378-173c-45cd-800d-273f405ab31b",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="600m",driver_memory="512m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-2f70e378-173c-45cd-800d-273f405ab31b.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-2f70e378-173c-45cd-800d-273f405ab31b.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
