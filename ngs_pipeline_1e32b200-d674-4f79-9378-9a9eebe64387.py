...
dag_run_uuid = "1e32b200-d674-4f79-9378-9a9eebe64387"
...
with DAG(
    dag_id="ngs-pipeline-1e32b200-d674-4f79-9378-9a9eebe64387",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="300m",driver_memory="2048m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-1e32b200-d674-4f79-9378-9a9eebe64387.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-1e32b200-d674-4f79-9378-9a9eebe64387.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
