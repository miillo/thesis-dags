...
dag_run_uuid = "a008afbd-40e0-4464-bc0c-8baa146c8691"
...
with DAG(
    dag_id="ngs-pipeline-a008afbd-40e0-4464-bc0c-8baa146c8691",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="700m",driver_memory="1024m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-a008afbd-40e0-4464-bc0c-8baa146c8691.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-a008afbd-40e0-4464-bc0c-8baa146c8691.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
