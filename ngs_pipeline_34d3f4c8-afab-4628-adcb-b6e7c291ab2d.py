...
dag_run_uuid = "34d3f4c8-afab-4628-adcb-b6e7c291ab2d"
...
with DAG(
    dag_id="ngs-pipeline-34d3f4c8-afab-4628-adcb-b6e7c291ab2d",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="4",executor_memory="512m",driver_memory="512m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-34d3f4c8-afab-4628-adcb-b6e7c291ab2d.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-34d3f4c8-afab-4628-adcb-b6e7c291ab2d.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
