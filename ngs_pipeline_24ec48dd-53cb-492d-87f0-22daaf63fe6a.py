...
dag_run_uuid = "24ec48dd-53cb-492d-87f0-22daaf63fe6a"
...
with DAG(
    dag_id="ngs-pipeline-24ec48dd-53cb-492d-87f0-22daaf63fe6a",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="600m",driver_memory="512m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-24ec48dd-53cb-492d-87f0-22daaf63fe6a.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-24ec48dd-53cb-492d-87f0-22daaf63fe6a.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
