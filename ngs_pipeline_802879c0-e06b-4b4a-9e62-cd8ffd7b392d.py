...
dag_run_uuid = "802879c0-e06b-4b4a-9e62-cd8ffd7b392d"
...
with DAG(
    dag_id="ngs-pipeline-802879c0-e06b-4b4a-9e62-cd8ffd7b392d",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-802879c0-e06b-4b4a-9e62-cd8ffd7b392d.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-802879c0-e06b-4b4a-9e62-cd8ffd7b392d.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
