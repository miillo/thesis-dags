...
dag_run_uuid = "77a1f86c-82bc-4a39-ad33-965015c34b48"
...
with DAG(
    dag_id="ngs-pipeline-77a1f86c-82bc-4a39-ad33-965015c34b48",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="6",executor_memory="600m",driver_memory="750m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-77a1f86c-82bc-4a39-ad33-965015c34b48.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-77a1f86c-82bc-4a39-ad33-965015c34b48.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
