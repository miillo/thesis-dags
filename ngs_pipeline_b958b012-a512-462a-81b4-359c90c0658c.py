...
dag_run_uuid = "b958b012-a512-462a-81b4-359c90c0658c"
...
with DAG(
    dag_id="ngs-pipeline-b958b012-a512-462a-81b4-359c90c0658c",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="1",executor_memory="7000m",driver_memory="512m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-b958b012-a512-462a-81b4-359c90c0658c.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-b958b012-a512-462a-81b4-359c90c0658c.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
