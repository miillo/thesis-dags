...
dag_run_uuid = "d6be565a-a5bb-4170-b271-921d7601e35c"
...
with DAG(
    dag_id="ngs-pipeline-d6be565a-a5bb-4170-b271-921d7601e35c",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="1024m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-d6be565a-a5bb-4170-b271-921d7601e35c.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-d6be565a-a5bb-4170-b271-921d7601e35c.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
