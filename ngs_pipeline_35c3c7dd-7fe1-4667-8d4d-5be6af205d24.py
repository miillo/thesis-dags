...
dag_run_uuid = "35c3c7dd-7fe1-4667-8d4d-5be6af205d24"
...
with DAG(
    dag_id="ngs-pipeline-35c3c7dd-7fe1-4667-8d4d-5be6af205d24",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="512m",driver_memory="1024m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-35c3c7dd-7fe1-4667-8d4d-5be6af205d24.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-35c3c7dd-7fe1-4667-8d4d-5be6af205d24.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
