...
dag_run_uuid = "fb7d0ee7-f3c6-49cf-9d10-5a1641e1dc7d"
...
with DAG(
    dag_id="ngs-pipeline-fb7d0ee7-f3c6-49cf-9d10-5a1641e1dc7d",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="500m",driver_memory="1024m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-fb7d0ee7-f3c6-49cf-9d10-5a1641e1dc7d.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-fb7d0ee7-f3c6-49cf-9d10-5a1641e1dc7d.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
