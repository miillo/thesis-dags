...
dag_run_uuid = "d8359a00-6e86-42c1-896c-5fc2db0c1141"
...
with DAG(
    dag_id="ngs-pipeline-d8359a00-6e86-42c1-896c-5fc2db0c1141",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="10",executor_memory="2048m",driver_memory="2048m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-d8359a00-6e86-42c1-896c-5fc2db0c1141.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-d8359a00-6e86-42c1-896c-5fc2db0c1141.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
