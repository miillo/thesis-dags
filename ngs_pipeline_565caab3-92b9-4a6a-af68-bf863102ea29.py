...
dag_run_uuid = "565caab3-92b9-4a6a-af68-bf863102ea29"
...
with DAG(
    dag_id="ngs-pipeline-565caab3-92b9-4a6a-af68-bf863102ea29",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="4",executor_memory="512m",driver_memory="512m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-565caab3-92b9-4a6a-af68-bf863102ea29.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-565caab3-92b9-4a6a-af68-bf863102ea29.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
