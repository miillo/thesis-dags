...
dag_run_uuid = "80736c99-95d9-4980-b00b-6da3b3964845"
...
with DAG(
    dag_id="ngs-pipeline-80736c99-95d9-4980-b00b-6da3b3964845",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-80736c99-95d9-4980-b00b-6da3b3964845.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-80736c99-95d9-4980-b00b-6da3b3964845.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
