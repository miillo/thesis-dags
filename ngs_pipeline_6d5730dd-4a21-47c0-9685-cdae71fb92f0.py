...
dag_run_uuid = "6d5730dd-4a21-47c0-9685-cdae71fb92f0"
...
with DAG(
    dag_id="ngs-pipeline-6d5730dd-4a21-47c0-9685-cdae71fb92f0",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="512m",driver_memory="750m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-6d5730dd-4a21-47c0-9685-cdae71fb92f0.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-6d5730dd-4a21-47c0-9685-cdae71fb92f0.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
