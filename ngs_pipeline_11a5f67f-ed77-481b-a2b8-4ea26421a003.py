...
dag_run_uuid = "11a5f67f-ed77-481b-a2b8-4ea26421a003"
...
with DAG(
    dag_id="ngs-pipeline-11a5f67f-ed77-481b-a2b8-4ea26421a003",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-11a5f67f-ed77-481b-a2b8-4ea26421a003.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-11a5f67f-ed77-481b-a2b8-4ea26421a003.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
