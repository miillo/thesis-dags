...
dag_run_uuid = "f006b3f7-fa8d-4763-9e3a-f0619d943532"
...
with DAG(
    dag_id="ngs-pipeline-f006b3f7-fa8d-4763-9e3a-f0619d943532",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-f006b3f7-fa8d-4763-9e3a-f0619d943532.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-f006b3f7-fa8d-4763-9e3a-f0619d943532.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
