...
dag_run_uuid = "fd90cef7-647a-4acc-9357-821f7d56e8f0"
...
with DAG(
    dag_id="ngs-pipeline-fd90cef7-647a-4acc-9357-821f7d56e8f0",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-fd90cef7-647a-4acc-9357-821f7d56e8f0.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-fd90cef7-647a-4acc-9357-821f7d56e8f0.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
