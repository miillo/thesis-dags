...
dag_run_uuid = "f1f0bc53-5d02-4f2a-bf5b-a411d107cb1f"
...
with DAG(
    dag_id="ngs-pipeline-f1f0bc53-5d02-4f2a-bf5b-a411d107cb1f",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="30",executor_memory="1024m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-f1f0bc53-5d02-4f2a-bf5b-a411d107cb1f.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-f1f0bc53-5d02-4f2a-bf5b-a411d107cb1f.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
