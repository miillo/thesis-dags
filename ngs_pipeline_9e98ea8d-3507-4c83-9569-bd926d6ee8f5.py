...
dag_run_uuid = "9e98ea8d-3507-4c83-9569-bd926d6ee8f5"
...
with DAG(
    dag_id="ngs-pipeline-9e98ea8d-3507-4c83-9569-bd926d6ee8f5",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="4",executor_memory="550m",driver_memory="600m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-9e98ea8d-3507-4c83-9569-bd926d6ee8f5.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-9e98ea8d-3507-4c83-9569-bd926d6ee8f5.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
