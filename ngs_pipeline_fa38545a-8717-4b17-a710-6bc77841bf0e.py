...
dag_run_uuid = "fa38545a-8717-4b17-a710-6bc77841bf0e"
...
with DAG(
    dag_id="ngs-pipeline-fa38545a-8717-4b17-a710-6bc77841bf0e",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="1024m",driver_memory="1024m",machine_type="n1-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-fa38545a-8717-4b17-a710-6bc77841bf0e.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-fa38545a-8717-4b17-a710-6bc77841bf0e.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
