...
dag_run_uuid = "fbbc0c66-ca04-4d04-93e4-ad1598e58042"
...
with DAG(
    dag_id="ngs-pipeline-fbbc0c66-ca04-4d04-93e4-ad1598e58042",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="2",executor_memory="550m",driver_memory="600m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-fbbc0c66-ca04-4d04-93e4-ad1598e58042.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-fbbc0c66-ca04-4d04-93e4-ad1598e58042.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
