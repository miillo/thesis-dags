...
dag_run_uuid = "f25a38ef-5f64-42eb-91aa-063f15698fd1"
...
with DAG(
    dag_id="ngs-pipeline-f25a38ef-5f64-42eb-91aa-063f15698fd1",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="6",executor_memory="600m",driver_memory="512m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-f25a38ef-5f64-42eb-91aa-063f15698fd1.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-f25a38ef-5f64-42eb-91aa-063f15698fd1.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
