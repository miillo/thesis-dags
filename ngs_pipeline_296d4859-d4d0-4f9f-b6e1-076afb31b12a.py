...
dag_run_uuid = "296d4859-d4d0-4f9f-b6e1-076afb31b12a"
...
with DAG(
    dag_id="ngs-pipeline-296d4859-d4d0-4f9f-b6e1-076afb31b12a",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="15",executor_memory="512m",driver_memory="512m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-296d4859-d4d0-4f9f-b6e1-076afb31b12a.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-296d4859-d4d0-4f9f-b6e1-076afb31b12a.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
