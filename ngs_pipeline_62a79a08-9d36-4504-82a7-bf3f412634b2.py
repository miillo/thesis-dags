...
dag_run_uuid = "62a79a08-9d36-4504-82a7-bf3f412634b2"
...
with DAG(
    dag_id="ngs-pipeline-62a79a08-9d36-4504-82a7-bf3f412634b2",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="5",executor_memory="512m",driver_memory="750m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-62a79a08-9d36-4504-82a7-bf3f412634b2.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-62a79a08-9d36-4504-82a7-bf3f412634b2.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
