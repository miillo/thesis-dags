...
dag_run_uuid = "ed0aa7d7-4d47-4933-8c5f-4ccbdd301034"
...
with DAG(
    dag_id="ngs-pipeline-ed0aa7d7-4d47-4933-8c5f-4ccbdd301034",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="20",executor_memory="1024m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-ed0aa7d7-4d47-4933-8c5f-4ccbdd301034.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-ed0aa7d7-4d47-4933-8c5f-4ccbdd301034.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
