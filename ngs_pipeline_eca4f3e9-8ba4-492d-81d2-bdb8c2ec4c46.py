...
dag_run_uuid = "eca4f3e9-8ba4-492d-81d2-bdb8c2ec4c46"
...
with DAG(
    dag_id="ngs-pipeline-eca4f3e9-8ba4-492d-81d2-bdb8c2ec4c46",
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-eca4f3e9-8ba4-492d-81d2-bdb8c2ec4c46.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-eca4f3e9-8ba4-492d-81d2-bdb8c2ec4c46.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
