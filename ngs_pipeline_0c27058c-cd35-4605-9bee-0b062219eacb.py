...
dag_run_uuid = "0c27058c-cd35-4605-9bee-0b062219eacb"
...
with DAG(
    dag_id="ngs-pipeline-0c27058c-cd35-4605-9bee-0b062219eacb",
    ...
    def send_prom_metrics(push_gateway_address, **kwargs):
        ...
        g.labels(executor_instances="1",executor_memory="512m",driver_memory="1024m",machine_type="e2-standard-4", job_uuid=dag_run_uuid).set(time.time())
    ...
    alignment = SparkKubernetesOperator(
        ...
        application_file="resources/seqtender/alignment-0c27058c-cd35-4605-9bee-0b062219eacb.yaml",
        do_xcom_push=True,
        retries=8,
    ...
    annotation = SparkKubernetesOperator(
        ...
        namespace='default',
        kubernetes_conn_id="kubernetes_default",
        application_file="resources/seqtender/annotation-0c27058c-cd35-4605-9bee-0b062219eacb.yaml",
        do_xcom_push=True,
        retries=8,
        retry_delay=timedelta(seconds=30),
        dag=dag
